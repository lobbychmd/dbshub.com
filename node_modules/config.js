...
exports.db = function () {
    return mongo.db('MIS:MIS@222.73.240.112:27017/idc');
};
...
exports.doctree_config = {
    ...
    tables: {
        children: [
            { middleware: 'summary', type: 'alltable', text: '所有表' },
            { middleware: 'az', type: 'table', params:{ prefix: 't'} }
        ]
    },
    alltable: {children: [
            { query:  {ProjectName: '{ProjectName}'}, type: 'table' }
        ]},
    table: {table: 'MetaTable', text: 'TableName'},
    themes: {
        children: [
            { query:  {ProjectName: '{ProjectName}'}, type: 'theme' }
        ]
    },
    theme: {table: 'MetaTheme', text: 'Theme'},
    connections: {
        children: [
            { query:  {ProjectName: '{ProjectName}'}, type: 'connection' }
        ]
    },
    ...
    modules: {
        text: 'TableName', 
        children: [
            { type: 'module', query: {ProjectName: '{ProjectName}', ParentID:{"$in":['', null]}} }
        ]
    },
    "module": {
        table: 'MetaModule',
        ...
        fields:['ModuleID'],
        children: [
            { type: 'module', query: {ProjectName: '{ProjectName}', ParentID:'{ModuleID}'} }
        ]
    }
}
